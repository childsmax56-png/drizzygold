...
export const ALBUM_DESCRIPTIONS: Record<string, string> = {
  ...
  "We Are Young Money": "We Are Young Money is a compilation album by Young Money Entertainment, released December 21, 2009. It features the entire Young Money roster, including Lil Wayne, Nicki Minaj, and Drake. The album served as a formal introduction to the Young Money collective and was released during the height of Lil Wayne's commercial dominance following Tha Carter III.",
  "So Far Gone": "So Far Gone is Drake's third mixtape, released February 13, 2009. It became one of the most successful mixtapes ever released, spawning the hit singles \"Best I Ever Had\" and \"Successful\". The project's mainstream success led to a bidding war between major labels, ultimately resulting in Drake signing with Young Money/Cash Money/Universal. It was later released as a commercial EP and is widely credited as the project that launched Drake into mainstream stardom.",
  "Thank Me Later": "Thank Me Later is Drake's debut studio album, released June 15, 2010. It debuted at number one on the Billboard 200 and was certified platinum in the United States. The album features collaborations with Kanye West, Jay-Z, Lil Wayne, Nicki Minaj, Alicia Keys, and Young Jeezy, among others. Despite being a commercial success, Drake has since spoken critically of the album, feeling it was released before he was ready.",
  "Take Care": "Take Care is Drake's second studio album, released November 15, 2011. The album is widely regarded as one of the greatest rap albums ever made, exploring themes of fame, love, loss, and introspection through a moody, atmospheric production led by Noah \"40\" Shebib. It features guest appearances from Rihanna, The Weeknd, Nicki Minaj, and André 3000. The album won the Grammy Award for Best Rap Album in 2013.",
  "Nothing Was The Same": "Nothing Was The Same is Drake's third studio album, released September 24, 2013. It is a more focused and personal album than its predecessors, debuting at number one on the Billboard 200. The album features production largely from Noah \"40\" Shebib and includes hits such as \"Started From the Bottom\" and \"Hold On, We're Going Home,\" the latter of which won a Grammy for Best Rap/Sung Collaboration.",
  "If You're Reading This It's Too Late": "If You're Reading This It's Too Late is a commercial mixtape by Drake, surprise-released on February 13, 2015. It became the first project in history to chart entirely based on streaming data. The project went on to be certified 5x platinum in the US and Canada. It features \"Know Yourself,\" \"Energy,\" and \"Legend,\" and was released amid Drake's ongoing dispute with Cash Money Records.",
  "What A Time To Be Alive": "What A Time To Be Alive is a collaborative mixtape by Drake and Future, released September 20, 2015. The project was recorded in just six days in Atlanta. It debuted at number one on the Billboard 200, making both Drake and Future the first artists to simultaneously top the chart with solo projects and a collab. The mixtape's success solidified the friendship and creative partnership between the two artists.",
  "Views": "Views is Drake's fourth studio album, released April 29, 2016. The album spent 13 consecutive weeks at number one on the Billboard 200 and became the first album to be streamed over one billion times on Apple Music. Features include \"One Dance,\" \"Hotline Bling,\" and \"Too Good.\" The album is noted for its Toronto-centric themes and its fusion of rap, dancehall, and pop.",
  "More Life": "More Life is a \"playlist\" by Drake, released March 18, 2017. Drake described it as a playlist rather than an album, featuring 22 tracks across a wide range of genres including dancehall, grime, Afrobeats, and R&B. It broke multiple streaming records upon release and features notable guest appearances from artists like Young Thug, Giggs, PartyNextDoor, Travis Scott, and Jorja Smith.",
  "Scorpion [V1]": "Scorpion is Drake's fifth studio album, a double album released June 29, 2018. Side A is rap and trap-influenced, while Side B focuses on R&B and pop. The album directly addressed Pusha-T's diss track \"The Story of Adidon,\" in which Pusha revealed Drake's secret son Adonis. Scorpion broke multiple one-day and one-week streaming records upon release. The album includes \"God's Plan,\" \"Nice For What,\" and \"In My Feelings.\"",
  "Scorpion [V2]": "Scorpion is Drake's fifth studio album, a double album released June 29, 2018. Side A is rap and trap-influenced, while Side B focuses on R&B and pop. The album directly addressed Pusha-T's diss track \"The Story of Adidon,\" in which Pusha revealed Drake's secret son Adonis. Scorpion broke multiple one-day and one-week streaming records upon release. The album includes \"God's Plan,\" \"Nice For What,\" and \"In My Feelings.\"",
  "Certified Lover Boy [V1]": "Certified Lover Boy is Drake's sixth studio album, originally announced for a January 2021 release but delayed due to Drake recovering from knee surgery. The album was finally released September 3, 2021, breaking several streaming records. CLB features 21 tracks and guest appearances from Jay-Z, Travis Scott, Lil Wayne, Future, and Young Thug, among others. Its cover, depicting pregnant woman emojis, became one of the most discussed album covers of 2021.",
  "Certified Lover Boy [V2]": "Certified Lover Boy is Drake's sixth studio album, originally announced for a January 2021 release but delayed due to Drake recovering from knee surgery. The album was finally released September 3, 2021, breaking several streaming records. CLB features 21 tracks and guest appearances from Jay-Z, Travis Scott, Lil Wayne, Future, and Young Thug, among others. Its cover, depicting pregnant woman emojis, became one of the most discussed album covers of 2021.",
  "Scary Hours 3": "Scary Hours 3 is a six-track EP released by Drake on November 17, 2023 as a deluxe addition to For All The Dogs. The EP was announced just one month after For All The Dogs dropped and was titled \"For All The Dogs Scary Hours Edition\" upon release. It features cameos from SZA and J. Cole and continues the aggressive, rap-focused tone of the main album.",
  "It's Never Enough": "It's Never Enough is a Drake-associated project or era featuring material that was worked on during various periods of his career. The era is noted for its collection of unreleased tracks and collaborations that did not make it onto official albums.",
  "100 GIGS": "100 GIGS refers to a massive, historic leak of Drake material that surfaced online, comprising over 100 gigabytes of unreleased music, sessions, and project files. The leak included stems, reference tracks, and full songs spanning multiple eras of Drake's career, making it one of the largest leaks in hip-hop history.",
};
